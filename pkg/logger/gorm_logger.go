...
// GormLogger操作对象，实现gormlogger.Interface
type GormLogger struct {
	ZapLogger     *zap.Logger
	SlowThreshold time.Duration
}

// NewGormLogger外部调用，实例化一个GormLogger对象
func NewGormLogger() GormLogger {
	return GormLogger{
		ZapLogger:     Logger,                 //
		SlowThreshold: 200 * time.Millisecond, // 慢查询阈值，单位为ms
	}
}
...
// Info实现gromlogger.Interface的Info方法
func (l GormLogger) Info(ctx context.Context, str string, args ...interface{}) {
	l.logger().Sugar().Debugf(str, args...)
}

// Warn实现gromlogger.Interface的Warning方法
func (l GormLogger) Warn(ctx context.Context, str string, args ...interface{}) {
	l.logger().Sugar().Warnf(str, args...)
}

// Error实现gromlogger.Interface的Error方法
func (l GormLogger) Error(ctx context.Context, str string, args ...interface{}) {
	l.logger().Sugar().Errorf(str, args...)
}

// Trace实现gromlogger.Interface的Trace方法
